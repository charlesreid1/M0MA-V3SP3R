    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Scope (free-form)") },
                placeholder = { Text("What you're authorized to test") },
                modifier = Modifier.fillMaxWidth(),
            )
            OutlinedTextField(
                value = scopeTargetsRaw,
                onValueChange = { scopeTargetsRaw = it },
                label = { Text("In-scope targets (one per line)") },
            ...
            Button(
                ...
                enabled = name.isNotBlank() && scope.isNotBlank() && scopeTargetsRaw.isNotBlank(),
                modifier = Modifier.fillMaxWidth(),
            ) {
                Text("Start")
            }
